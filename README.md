...
- [Slither](#slither)
- [Thank you!](#thank-you)
- [Indexed-Stablecoin](#indexed-stablecoin)
...
There are two types of price feeds involved here:

Price feeds for the collateral: These are used to determine the value of the collateral in USD when a user wants to mint DSC coins. For example, if a user wants to mint DSC coins by depositing WETH as collateral, the DSCEngine contract uses the price feed for WETH to determine the equivalent value of the WETH in USD.
Price feeds for the DSC coin: These are used to determine the value of the DSC coin in USD. The value of the DSC coin is determined based on the total value of the collateral deposited by all users, divided by the total supply of DSC coins.
