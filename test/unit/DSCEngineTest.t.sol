...
contract DSCEngineTest is StdCheats, Test {
    ...
    function setUp() external {
        ...
        priceFeeds[0] = AggregatorV3Interface(ethUsdPriceFeed);
        priceFeeds[1] = AggregatorV3Interface(btcUsdPriceFeed);

        // Instantiate the IndexedAssetPriceFeed with the price feeds
        IndexedAssetPriceFeed indexedAssetPriceFeed = new IndexedAssetPriceFeed(priceFeeds);

        // Store the address of the IndexedAssetPriceFeed instance if needed
        indexedAssetPriceFeedAddress = address(indexedAssetPriceFeed);
    ...
    function testRevertsIfTokenLengthDoesntMatchPriceFeeds() public {
        ...
        new DSCEngine(tokenAddresses, feedAddresses, address(dsc), indexedAssetPriceFeedAddress);
    }
